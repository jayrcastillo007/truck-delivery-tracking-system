@include('partials.header')
    <header class="max-w-lg mx-auto">
        <a href="#">
            <h1 class="text-4xl font-bold text-white text-ceneter pl-5">User Register</h1>
        </a>
    ...
    <main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2xl">
        <section>
            ...
            <p class="text-gray-600 pt-2">Sign in to your account <a href="/login" class="font-bold text-sky-500">here</a></p>
        </section>
        ...
        <section class="mt-10">
            <form action="/store" method="POST" class="flex flex-col">
                ...
                <button type="submit" class="bg-sky-500/50 hover:bg-sky-500/75 text-white font-bold py-2 rounded shadow-lg hover:show-xl transition duration-200">Sign up</button>
