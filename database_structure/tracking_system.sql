...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 02, 2026 at 07:27 AM
...
CREATE TABLE IF NOT EXISTS `driver_locations` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `driver_locations_transaction_id_tracked_at_index` (`transaction_id`,`tracked_at`),
  KEY `driver_locations_driver_id_tracked_at_index` (`driver_id`,`tracked_at`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `transactions` (
  ...
  `pickup_long` decimal(11,8) DEFAULT NULL,
  `dropoff_location` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `dropoff_lat` decimal(10,8) DEFAULT NULL,
  `dropoff_long` decimal(11,8) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `vehicles` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `vehicle_plate_number_unique` (`plate_number`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
COMMIT;
...
(1, 'System Admin', 'admin@tracking.com', NULL, '$2y$12$Jlt/bY6gqLcDRs.t/B218.ALyNd9hFNrE6dQ2LIx3dquKqg5YRLQq', 'admin', NULL, NOW(), NOW());
